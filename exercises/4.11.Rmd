...
Then the test error using linear discriminant analysis is `r te_lda`
...
Then the test error using quadratic discriminant analysis is `r te_qda`
...
The test error using logistic regression is `r te_glm`
...
The test error using $k$-nearest neighbor classification with $k=1$ is `r te_knn1`
...
The test error using $k$-nearest neighbor classification with $k=10$ is `r te_knn10`
...
The test error using $k$-nearest neighbor classification with $k=100$ is `r te_knn100`
